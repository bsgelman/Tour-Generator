...
{
    GeoDatabase geodb;
    if (!geodb.load("C:/Users/benja/Downloads/P4_test/mapdata.txt"))
    {
        cout << "Unable to load map data: " << "C:/Users/benja/Downloads/P4_test/mapdata.txt" << endl;
        return 1;
    }
    ...
    Stops stops;
    if (!stops.load("C:/Users/benja/Downloads/P4_test/stops.txt"))
    {
        cout << "Unable to load tour data: " << "C:/Users/benja/Downloads/P4_test/stops.txt" << endl;
        return 1;
    }
